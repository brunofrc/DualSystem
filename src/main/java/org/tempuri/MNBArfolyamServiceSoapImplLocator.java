...
public class MNBArfolyamServiceSoapImplLocator extends org.apache.axis.client.Service implements org.tempuri.MNBArfolyamServiceSoapImpl {
    ...
    public hu.mnb.www.webservices.MNBArfolyamServiceSoap getCustomBinding_MNBArfolyamServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public hu.mnb.www.webservices.MNBArfolyamServiceSoap getCustomBinding_MNBArfolyamServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.tempuri.CustomBinding_MNBArfolyamServiceSoapStub _stub = new org.tempuri.CustomBinding_MNBArfolyamServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (hu.mnb.www.webservices.MNBArfolyamServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.tempuri.CustomBinding_MNBArfolyamServiceSoapStub _stub = new org.tempuri.CustomBinding_MNBArfolyamServiceSoapStub(new java.net.URL(CustomBinding_MNBArfolyamServiceSoap_address), this);
                _stub.setPortName(getCustomBinding_MNBArfolyamServiceSoapWSDDServiceName());
                return _stub;
            }
        }
